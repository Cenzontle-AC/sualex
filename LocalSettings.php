...
# Load ENV vars
$envFile = realpath(__DIR__ . "/../.sualexenv");
...
$wgLogos = [
    '1x' => "$wgResourceBasePath/images/sualex-logo.png",
    'icon' => "$wgResourceBasePath/images/sualex-logo.png",
];
...
$wgRightsText = "Creative Commons Attribution-NonCommercial 4.0 International";
$wgRightsIcon = "$wgResourceBasePath/images/cc-by-nc.svg";
